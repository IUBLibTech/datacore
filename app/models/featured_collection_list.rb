class FeaturedCollectionList
  ...
  # @param [ActionController::Parameters] a collection of nested parameters
  ...
  def collection_presenters
    ...
    Hyrax::PresenterFactory.build_for(ids: ids,
                                      presenter_class: Hyrax::CollectionPresenter,  # TODO:  unsure
                                      presenter_args: ability)
  end

  def collection_with_id(id)
    @collections.find { |w| w.collection_id == id }
  end
end
