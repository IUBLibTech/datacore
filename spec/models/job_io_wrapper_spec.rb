...
class MockUploadedFile
  ...
  # def initialize(is_filetype)
  #   @is_filetype = is_filetype
  # end

  def uploader
    OpenStruct.new(filename: "the file name", content_type: "image/jpeg")  # , path: "filial path"
  end
...
RSpec.describe JobIoWrapper do
  ...
  pending "#self.create_with_varied_file_handling!"
  ...
  describe "#original_name" do
    ...
    context "when calling parent method does not return a value" do
      ...
      it "returns super method call result" do
