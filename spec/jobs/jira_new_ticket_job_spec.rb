  ...
  describe "#perform" do
    ...
    context "when jira_ticket_for_create raises an Exception" do
      before {
        ...
        allow(Deepblue::JiraHelper).to receive(:jira_ticket_for_create).with( curation_concern: work ).and_raise(Exception)
      ...
      it "calls Rails.logger.error twice" do
        ...
        expect(Deepblue::JiraHelper).to receive(:jira_ticket_for_create).with( curation_concern: work ).and_raise(Exception)
