...
RSpec.describe Deepblue::EmailHelper, type: :helper do
  ...
  describe '#self.curation_concern_url' do
    ...
    skip "Add tests for DataSet, FileSet, and Collection parameters"

    context "when parameter is not a DataSet, FileSet, or Collection" do
      it "returns blank" do
        expect(Deepblue::EmailHelper.curation_concern_url(curation_concern: "concern")).to eq ""
      end
    end
  end
  ...
  describe "#self.echo_to_rails_logger" do
    it "returns true" do
      expect(Deepblue::EmailHelper.echo_to_rails_logger).to eq true
    end
  end
  ...
  describe "#self.hostname" do
    ...
    context "when Settings.hostname is nil" do
      before {
  ...
  describe "self.user_email_from" do
    context "when user not signed in" do
      it "returns blank" do
        expect(Deepblue::EmailHelper.user_email_from "current user", user_signed_in: false).to be_blank
      end
    end

    context "when current user is nil" do
      it "returns blank" do
        expect(Deepblue::EmailHelper.user_email_from nil, user_signed_in: true).to be_blank
      end
    end
