...
RSpec.describe Deepblue::MetadataHelper, type: :helper do
  ...
  # describe "self.attribute_names_user" do
  #   context "when class variable is set" do
  #     before {
  #       Deepblue::MetadataHelper.class_variable_set(:@@variable_name, "attribute names user")
  #       #MetadataHelperMock.class.instance_variable_set(:@attribute_names_user, "attribute names user")
  #     }
  #     it "returns class variable" do
  #       expect(Deepblue::MetadataHelper.attribute_names_user).to eq "attribute names user"
  #     end
  #
  #     after {
  #       Deepblue::MetadataHelper.class_variable_set(:@@variable_name, nil)
  #     }
  #   end
  #
  #   context "when class variable is NOT set" do
  #     before {
  #       allow(User).to receive(:attribute_names).and_return ["sapphire", "diamond", "ruby"]
  #     }
  #     it "returns sorted User attribute_names" do
  #       expect(Deepblue::MetadataHelper.attribute_names_user).to eq ["diamond", "ruby", "sapphire"]
  #     end
  #   end
  # end
  ...
  #   it "returns hash of attribute name keys with value of true" do
  #     expect(Deepblue::MetadataHelper.init_attribute_names_always_include_cc).to eq {}
      # :admin_set_id = true,
      #   "authoremail" = true,
      #   "creator" => true,
  ...
  describe "#self.log_provenance_migrate" do
    context "when source parameter is 'DBDv1'" do
      ...
      context "when parent parameter is present" do
        ...
        it "calls ProvenanceLogger message with text including parent parameter" do
  ...
  describe "#self.metadata_filename_collection" do
    it "returns string" do
      expect(Deepblue::MetadataHelper.metadata_filename_collection ["path_dir1/", "path_dir2/"],
                                                             OpenStruct.new(id: "collection_id")).to eq "path_dir1/w_collection_id_metadata_report.txtpath_dir2/"
    end
  end
  ...
  describe "#self.metadata_filename_collection_work" do
    it "returns string" do
      expect(Deepblue::MetadataHelper.metadata_filename_collection_work ["path_dir1/", "path_dir2/"], OpenStruct.new(id: "collection_id"),
                                                             OpenStruct.new(id: "work_id")).to eq "path_dir1/c_collection_id_w_work_id_metadata_report.txtpath_dir2/"
    end
  end
  ...
  describe "#self.metadata_filename_work" do
    it "returns string" do
      expect(Deepblue::MetadataHelper.metadata_filename_work ["path_dir1/", "path_dir2/"],
                                                             OpenStruct.new(id: "work_id")).to eq "path_dir1/w_work_id_metadata_report.txtpath_dir2/"
    end
  end
    ...
    context "when do_ordered_list_hack evaluates to positive" do
      ...
      context "when DeserializeError occurs" do
        before {
         ...
         it "calls OrderedStringHelper.deserialize on ordered_values parameter and errors" do
  ...
  describe "#self.report_collection_work" do
    context "when the out parameter is nil" do
      it "calls report_collection_work and opens metadata_filename_collection_work" do
        skip "Add a test for recursion"
      end
    end
  ...
  describe "#self.report_work" do
    context "when the out parameter is nil" do
      it "calls report_work on target_file and returns target_file" do
        skip "Add a test for open (file)"
      end
    end

    context "when the out parameter is NOT nil" do  #291
      ...
      before {
        ...
        allow(Deepblue::MetadataHelper).to receive(:report_work_datasets).with(["a1 file", "b2 file", "c3 file"], out: output, depth: '==')
      }
  ...
  describe "#self.report_item" do   #332
    before {
    }
      ...
      context "when value is an enumerator" do
        ...
        context "when value has one item" do
          it "puts label and value" do
            expect(out_print).to receive(:puts).with "label"
            expect(out_print).to receive(:puts).with "pre_exception_post"
            Deepblue::MetadataHelper.report_item(out_print, "label", "exception", item_prefix: "pre_", item_postfix: "_post",
  ...
  describe "#self.yaml_body_files" do  # 450
  ...
  describe "#self.yaml_body_works" do  #576
    ...
    it "calls yaml functions but skips functions with attribute names" do
  ...
  describe "#self.yaml_export_file_path" do
    ...
    it "returns string" do
      expect(Deepblue::MetadataHelper.yaml_export_file_path target_dirname: ["dir1 ", " dir2"], file_set: file_set).to eq "dir1 V-533_the original dir2"
    end
  end
  ...
  describe "#self.yaml_file_set_id" do
    it "returns string with file set id" do
  ...
  describe "#self.yaml_is_a_work?" do
    context "when source parameter is 'DBDv2'" do
      it "returns true when curation_concern parameter is a DataSet" do
        expect(Deepblue::MetadataHelper.yaml_is_a_work? curation_concern: DataSet.new, source: "DBDv2").to eq true
      end
    end

    context "when source parameter is NOT 'DBDv2'" do
      it "returns true when curation_concern parameter is a GenericWork" do
  ...
  describe "#self.yaml_item" do       #717
  ...
  describe "#self.yaml_item_collection" do
    context "when ATTRIBUTE_NAMES_IGNORE includes name parameter" do
      it "returns nil" do
        expect(Deepblue::MetadataHelper.yaml_item_collection "out", "indent", "curation concern", name: "collection_type_gid")
      end
    end

    context "when file_set value is blank and ATTRIBUTE_NAMES_ALWAYS_INCLUDE_CC does not include name" do
      it "returns nil" do
        expect(Deepblue::MetadataHelper.yaml_item_collection "out", "indent", { }, name: "writer")
      end
    end

    context "when ATTRIBUTE_NAMES_IGNORE does NOT include name and curation_concern value is not blank" do
      before {
      ...
      it "calls yaml_item with parameters" do
        ...
        expect(Deepblue::MetadataHelper.yaml_item_collection "out", "indent", {"writer" => "novelist"}, name: "writer")
      end
    end
  end
  ...
  describe "#self.yaml_item_file_set" do
    context "when ATTRIBUTE_NAMES_IGNORE includes name parameter" do
      it "returns nil" do
        expect(Deepblue::MetadataHelper.yaml_item_file_set("out", "indent", "file set", name: "file_size" )).to be_blank
      end
    end

    context "when file_set value is blank and ATTRIBUTE_NAMES_ALWAYS_INCLUDE_FILE_SET does not include name" do
      it "returns nil" do
        expect(Deepblue::MetadataHelper.yaml_item_file_set("out", "indent", OpenStruct.new(file_size: ""), name: "file_size" )).to be_blank
      end
    end

    context "when ATTRIBUTE_NAMES_IGNORE does NOT include name and file_set value is not blank" do
      before {
  ...
  describe "#self.yaml_item_user" do
    context "when name is ignored attribute name" do
      it "returns nil" do
        expect(Deepblue::MetadataHelper.yaml_item_user "out", "indent", {"name" => "baby"}, name: "reset_password_token").to be_blank
      end
    end

    context "when value is blank and ATTRIBUTE_NAMES_ALWAYS_INCLUDE_USER does not include name" do
      it "returns nil" do
    ...
    context "when value is not blank" do
      ...
      it "calls yaml_item with only allowed attribute names" do
  ...
  describe "#self.yaml_item_work" do
    context "when name is ignored attribute name" do
      it "returns nil" do
        expect(Deepblue::MetadataHelper.yaml_item_work "out", "indent", {"curation" => "concern"}, name: "head").to be_blank
      end
    end

    context "when value is blank and ATTRIBUTE_NAMES_ALWAYS_INCLUDE_CC does not include name" do
      it "returns nil" do
  ...
  describe "#self.yaml_populate_users" do   #906
    ...
    context "when out parameter is not nil" do
      ...
      before {
        allow(Dir).to receive(:exist?).with(Pathname.new("/deepbluedata-prep/")).and_return true
  ...
  describe "#self.yaml_targetdir" do
    context "when pathname_dir is not a Pathname object" do
      before {
        allow(Pathname).to receive(:new).with("pathname dir").and_return ["Pathname object 1", "Pathname object 2"]
      }
      it "creates new pathname with parameters" do
        expect(Pathname).to receive(:new).with("pathname dir")
        expect(Deepblue::MetadataHelper.yaml_targetdir pathname_dir: "pathname dir", id: "I-0001", prefix: "y_", task: "decimate").to eq "Pathname object 1y_I-0001_decimatePathname object 2"
      end
    end
  ...
  pending "self.yaml_work_export_files"
