...
RSpec.describe Hyrax::Dashboard::CollectionsController do
  ...
  describe "#process_banner_input" do
    ...
    context "when banner_unchanged param false and banner_files param true" do
      before {
      ...
      it "returns update_existing_banner" do
        expect(subject).not_to receive(:update_existing_banner)
        expect(subject).to receive(:remove_banner)
    ...
    context "when banner_unchanged param false and banner_files param false" do
      before {
  ...
  describe "#update_existing_banner" do
    ...
    before {
      ...
      allow(subject).to receive(:collection_banner_info).with(id: 3000).and_return [banner_info1, BannerInfoMock.new("path2")]
    }
    it do
  ...
  describe "#add_new_banner" do
    ...
    before {
      ...
      allow(subject).to receive(:uploaded_files).with(12).and_return [OpenStruct.new(file_url: "kawaii"), OpenStruct.new(file_url: "banzai")]
    ...
    it do
      expect(subject).to receive(:uploaded_files).with(12)
